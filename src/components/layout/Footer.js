...
const Footer = () => {
  ...
  const footerSections = {
    services: [
      { name: 'Live Scores API', href: '/services/live-scores' },
      { name: 'Betting Platform', href: '/services/betting-platform' },
      { name: 'Casino Games', href: '/services/casino-games' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4">
              Leading provider of sports APIs and gaming solutions for modern businesses.
            </p>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <Link href="mailto:info@igames.cloud" className="text-gray-600 dark:text-gray-300 hover:text-[#3B82F6] dark:hover:text-[#60A5FA]">
                  info@igames.cloud
                </Link>
              </div>
              <div className="flex items-center space-x-2">
                <FaPhone className="w-4 h-4 text-[#3B82F6] dark:text-[#60A5FA]" />
                <Link href="tel:+15551234567" className="text-gray-600 dark:text-gray-300 hover:text-[#3B82F6] dark:hover:text-[#60A5FA]">
                  +1 (555) 123-4567
                </Link>
              </div>
            </div>
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold mb-3 text-[#3B82F6] dark:text-[#60A5FA]">Services</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-semibold mb-3 text-[#3B82F6] dark:text-[#60A5FA]">Company</h3>
            <ul className="space-y-2">
          ...
          {/* Support */}
          <div>
            <h3 className="font-semibold mb-3 text-[#3B82F6] dark:text-[#60A5FA]">Support</h3>
            <ul className="space-y-2">
          ...
          {/* Legal */}
          <div>
            <h3 className="font-semibold mb-3 text-[#3B82F6] dark:text-[#60A5FA]">Legal</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center text-xs text-gray-500 dark:text-gray-400 space-y-2 sm:space-y-0">
              <p>&copy; {currentYear} iGames.cloud. All rights reserved.</p>
